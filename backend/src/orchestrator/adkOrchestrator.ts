...
// ============================================================
// Orchestration Events (streamed to frontend via SSE)
// ============================================================
    ...
    try {
      ...
      if (db) {
        try {
          ...
          console.log(`💾 Saved session ${sessionId} to Firestore`);
        } catch (fsError) {
          console.error(`❌ Failed to save session to Firestore:`, fsError);
        }
      }
