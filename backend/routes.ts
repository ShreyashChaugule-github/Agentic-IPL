...
// Returns sessionId immediately; use SSE for live updates
// ============================================================
router.post('/debate', async (req: Request, res: Response) => {
  try {
    ...
    // Don't await — let it run, client streams via SSE
...
// ============================================================
// POST /api/debate/sync — Synchronous mode (waits for result)
